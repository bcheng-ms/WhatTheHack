...
1.  In the accompanying source code, modify the `Resources/Infrastructure/bicep/env/main.parameters.json` file so it contains unique information for your deployment:

    ```json
    {
        "appName": {
            "value": "<your-initials><3-random-numbers>dapr"
        },
        "region": {
            "value": "ussc"
        },
